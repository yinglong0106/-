<template>
  <el-dialog title="供应机构成果" :visible.sync="open" width="700px" @closed="$emit('update:open', false)" @opened="initData">
    <div style="padding-bottom: 60px;">
      <tab-title-info :currentRow="currentRow" />
      <div class="title-bg mb10">采购订单验收通过数量({{count}})</div>
      ...
      <el-table v-loading="loading" border :data="dataList">
        ...
        <el-table-column label="采购订单验收通过数量" prop="orderNum" align="center" :show-overflow-tooltip="true"/>
      </el-table>
...
<script>
import { resultList, getResultCount } from '@/api/supplyRoleApi/joinManagement';
  ...
  methods: {
    async getList() {
      ...
      const res = await resultList({
        ...
        orgStalogST2Guid: this.currentRow.orgStalogST2Guid,
