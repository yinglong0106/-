<template>
  <div class="app-container">
    ...
    <newAtt v-if="isNew" @close="closeNew" :pageStatus="pageStatus" :row="openRow" @refresh="selectMGgetListByRK"></newAtt>
