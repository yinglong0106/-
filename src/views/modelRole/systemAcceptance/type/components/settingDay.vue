		...
		<el-row>
			...
			<div class="flex mb20 flex-center">
				...
				<div class="flex flex-center">
					<el-input style="width: 120px;margin-right: 10px;" :min='0' :max='9999' v-model="appointDay" placeholder="请填写"
						type="number" oninput="if(!/^[0-9]+$/.test(value)) value=value.replace(/\D/g,'');if(value>9999)value=9999;if(value<0)value=null"></el-input>小时
				</div>
			</div>
		</el-row>
		<el-row>
