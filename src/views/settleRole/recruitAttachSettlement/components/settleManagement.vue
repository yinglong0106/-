<template>
	<el-dialog title="招募专员结算管理" :visible.sync="isOpen" width="900px" @close="beforeClose">
		...
		<el-row style="padding-bottom: 60px;">
			<el-table :data="tableData" border height="50vh" v-loading="loading">
				<el-table-column prop="userName" label="账号名称" align="center" width="200">
				</el-table-column>
				...
				<el-table-column prop="nation" label="国家/区号" align="center" width="120">
				</el-table-column>
				<el-table-column prop="phonenumber" label="联系电话" align="center" width="110">
				</el-table-column>
...
<script>
	...
	import {
		SumByYMOfST3UserList,
		exportMonthDetailList
	} from '@/api/settleRoleApi/recruitAttachSettlement.js'
	export default {
		name: "index",
		components: {
			pages
		...
		methods: {
			...
			async SumByYMOfST3UserList() {
				this.loading = true
				await SumByYMOfST3UserList({
					year: this.row.year,
					month: this.row.month,
					phonenumber: this.searchVal,
					size: '20',
