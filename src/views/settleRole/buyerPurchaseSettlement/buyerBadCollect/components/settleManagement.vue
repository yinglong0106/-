<template>
	<el-dialog title="结算管理" :visible.sync="isOpen" width="900px" @close="beforeClose">
		...
		<!-- 申请账号信息 -->
		<userMessage v-if="isUserMessage" @close="closeAccountNumber" :row="openRow" :userId="openRow.demandUserId" :pageType='pageType'></userMessage>
		<!-- 申请账号信息 end -->
		<confirmPenaltyPop v-if="isConfirm" @close="closeConfirmPenalty" :row="openRow" @refresh="search" pageType="需方">
		</confirmPenaltyPop>
