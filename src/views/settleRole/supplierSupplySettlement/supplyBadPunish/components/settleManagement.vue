<template>
	<el-dialog title="结算管理" :visible.sync="isOpen" width="900px" @close="beforeClose">
			...
			<el-tab-pane label="未结算" name="first">
				...
				<el-row style="padding-bottom: 60px;">
					<el-table :data="tableData" border height="50vh" v-loading="loading">
						...
						<el-table-column prop="judgeFeeNo" label="账单编号" align="center" width="100">
						</el-table-column>
		...
		<!-- 申请账号信息 -->
		<userMessage v-if="isUserMessage" @close="closeAccountNumber" :userId="openRow.supplyUserId || openRow.userId" :pageType="pageType"></userMessage>
		<!-- 申请账号信息 end -->
