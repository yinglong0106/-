<template>
  <el-dialog title="查看日新增注册对象数量详情" :visible.sync="isOpen" width="900px" @close="beforeClose" :append-to-body="true">
    ...
    <serviceAttDetail v-if="isDetail" @close="closeAttDetail" :row="row" :secRow="secRow" :thrRow="openRow" pageStatus="1"></serviceAttDetail>
  </el-dialog>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        this.statisticGetDayRegNumByDirId()
      },
      async statisticGetDayRegNumByDirId() {
        this.loading = true
        statisticGetDayRegNumByDirId({
