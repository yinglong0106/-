<template>
  <div>
    <div class="flex flex-center mb10" v-for="(item,index) in tableData" :key="index">
      ...
      <el-input ref="input" placeholder="请选择" v-model="checkedList[index].name" @keyup.enter.native="toSearch" style="width: 200px;"
  ...
  export default {
    ...
    methods: {
      ...
      getByteGuid(data) {
        ...
        this.guidList[this.byteIndex] = data.guid
