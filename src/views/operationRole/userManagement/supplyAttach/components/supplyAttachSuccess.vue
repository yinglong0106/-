<template>
	<el-dialog title="供应专员成果" :visible.sync="isOpen" width="1000px" @close="beforeClose" append-to-body>
		<div style="padding-bottom: 60px;">
			...
			<div class="flex flex-center mb20">
				...
				<div class="ml0">展示有哪些供应机构关联过这个供应专员且统计为供应专员带来多少业绩</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async getOrgSuOrderNumByST2Uid() {
				this.loading = true
				await getOrgSuOrderNumByST2Uid({
